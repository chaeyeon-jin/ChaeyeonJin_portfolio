...
const About = ({ borderRadius, isToggled }) => {
  ...
  return (
    <section id="about" className={`w-full relative px-[80px] py-[80px] transition-colors duration-300 ${isToggled ? 'bg-variable-collection-black' : 'bg-variable-collection-background'}`}>
      <div className="grid grid-cols-6 gap-5">
        {/* Section Title */}
        <div className="col-span-6 flex items-start gap-[68px] mb-10">
          <div className={`relative w-fit font-mango-grotesque font-semibold italic text-8xl tracking-[0] leading-normal whitespace-nowrap transition-colors duration-300 ${isToggled ? 'text-variable-collection-white' : 'text-variable-collection-black'}`}>
            More about
          </div>
          <div className={`relative w-fit text-8xl leading-normal font-nohemi font-normal tracking-[0] whitespace-nowrap transition-colors duration-300 ${isToggled ? 'text-variable-collection-white' : 'text-variable-collection-black'}`}>
            Chaeyeon Jin
          </div>
        </div>
        ...
        <div className="col-span-1 h-[280px] flex items-center justify-center">
          <Image
            src="/SVG/StarYellow.svg"
            alt="Star"
            width={199}
            height={199}
            className="w-auto h-auto transition-transform duration-100 ease-out"
        ...
        {/* Text Box 1 - 3 cols */}
        <div 
          className="col-span-3 h-[280px] flex items-center justify-center px-10 bg-variable-collection-yellow transition-all duration-300 group cursor-pointer"
          style={{ borderRadius: `${borderRadius}px` }}
        >
          <p className="w-full font-nohemi font-normal text-variable-collection-grey300 text-[32px] tracking-[0] leading-[40.4px]">
        ...
        {/* Photos Image - 2 cols */}
        <div className="col-span-2 row-span-2 relative h-[580px]"> 
        ...
        <div 
          ...
          style={{ borderRadius: `${borderRadius}px` }}
        >
          <p className="w-full font-nohemi font-normal text-variable-collection-background text-[32px] tracking-[0] leading-[40.4px]">
        ...
        {/* Text Box 4 - 2 cols */}
        <div 
          className="col-span-2 h-[280px] flex items-center justify-center px-10 bg-variable-collection-background border border-gray-200 transition-all duration-300"
          style={{ borderRadius: `${borderRadius}px` }}
        >
          <p className="w-full font-nohemi font-normal text-variable-collection-yellow hover:text-variable-collection-black text-[32px] tracking-[0] leading-[32.4px]">
